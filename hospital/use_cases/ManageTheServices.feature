...
|Name|Pation ID|Departmant|Service|Doctor Name|Doctor ID|Payment method|
|Marah|P1|Internal Departmen|diagnosis|Dr.Aadam|D000|cash|
...
When user click on  Medical Services button
And  the user forgot to fill in a field "Name" or "Pation ID" or "Departmant" or "Service" or "Doctor Name" or "Doctor ID" or "Payment method" is empty
...
When user click on Medical Services button
And the Services  is not available "Service" is uncorrect
Then user should see "Soory the Service is not avilable" Massage

Scenario: Payment method un correct
Given user enters the "Payment method"
When user click on Medical Services button
And the Payment method is not available "Payment method" is uncorrect
Then user should see "Soory this uncorrect Payment method " Massage
